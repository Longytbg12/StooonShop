<?php 
	//include file model vao dday
	include "models/UsersModel.php";
	class UsersController extends Controller{
		//ke thua class UsersModel
		use UsersModel;
		public function index(){
			//qui dinh so ban ghi tren 1 trang
			$recordPerPage = 4;
			//tinh so trang
			//ham ceil(so) se lay ftri lam tron tren cua so do. VD: ceil(3.1) = 4
		...
		public function update(){
			...
			//tao bien $action de biet dc khi an nut trang se submit den dau
