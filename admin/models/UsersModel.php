<?php 
	trait UsersModel{
		//lay ve danh saxh cac ban ghi
		public function modelRead($recordPerPage){
			//lay bien page tu bien url
		...
		//lay mot ban ghi tuong ung vowis id truyen vao
		public function modelGetRecord(){
			...
			//thuc thi truy van, co truyf tham so vao cau lechj sql
		...
		public function modelUpdate(){
			...
			//neu password k roong thif update password
			if($password != ""){
				//ma hoa password
				$password = md5($password);
				//chuan bi truy van
				$query = $db->prepare("update users set password = :var_password where id=:var_id");
				//thuc thi truy van , co truyen tham so vao cau lechj sql
